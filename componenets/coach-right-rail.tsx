...
export function CoachRightRail({ isFocusMode }: CoachRightRailProps) {
      ...
      <div className="space-y-6">
              ...
              <div key={index} className="space-y-2">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className={cn("text-sm font-medium", !hint.unlocked && "text-muted-foreground")}>
                      {hint.title}
                    </span>
                  </div>
        ...
        <Dialog open={isPanicDialogOpen} onOpenChange={setIsPanicDialogOpen}>
          <DialogTrigger asChild>
            <Button
              variant="outline"
              className="w-full justify-center border-orange-500/20 bg-orange-500/5 hover:bg-orange-500/10 text-orange-600"
            >
          ...
          <DialogContent className="sm:max-w-md">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                ...
                <Button className="flex-1 bg-gradient-to-r from-violet-500 to-lime-400 hover:from-violet-600 hover:to-lime-500">
